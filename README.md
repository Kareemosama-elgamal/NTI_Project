...
![Income Correlation](assets/income_correlation.png)
...
| Decision Tree | KNN |
|---|---|
| ![CM Decision Tree](assets/cm_decision_tree.png) | ![CM KNN](assets/cm_knn.png) |

| Logistic Regression | Random Forest |
|---|---|
| ![CM Logistic Regression](assets/cm_logistic_regression.png) | ![CM Random Forest](assets/cm_random_forest.png) |

### Choosing the Best K for KNN

![Best K Selection](assets/knn_best_k.png)

## 📉 ROC Curve Comparison

All four models compared on a single ROC plot:

![ROC Comparison](assets/roc_comparison_all_models.png)
...
| Decision Tree | KNN |
|---|---|
| ![ROC Decision Tree](assets/roc_decision_tree.png) | ![ROC KNN](assets/roc_knn.png) |

| Logistic Regression | Random Forest |
|---|---|
| ![ROC Logistic Regression](assets/roc_logistic_regression.png) | ![ROC Random Forest](assets/roc_random_forest.png) |
